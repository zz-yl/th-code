...
* @par 示例
* @code
*    crc = crc_get_crc16(buf, len);
* @endcode
*/
uint16_t crc_get_crc16(uint8_t *data, uint8_t len)
{
    uint32_t index;
    uint8_t crc_h = 0xFF;  //高CRC字节
    uint8_t crc_l = 0xFF;  //低CRC字节
    const uint8_t tab_h[] = {  //CRC高位字节值表
