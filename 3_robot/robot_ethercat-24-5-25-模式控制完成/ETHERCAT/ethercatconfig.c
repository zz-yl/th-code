...
{	
    ...
    {		
			...
			cur_status = inputs1->status_word;//0x6041
			switch(startup_step)
			{
//				case 1:
//				  outputs1->ControlWord = 0x06;//0x6040
//				  if((cur_status==0x1231)||(cur_status==0x0231))
//						 startup_step=2;
//				  printf("0x06\n");
//				break;
//			  case 2:
//					outputs1->ControlWord = 0x07;
//					if(cur_status==0x1233)
//						 startup_step=3;
//					printf("0x07\n");
//					break;
//				case 3:
//					outputs1->ControlWord = 0x0f;
//				 	if((cur_status==0x1237)||(cur_status==0x1233))
//						 startup_step=4;
//					break;
				case 4:
           outputs1->control_word = 0x0f;
				   outputs1->target_pos = cur_pos;//0x607A	
					...
					else if(csp_pos_delay <= 350)
					{
						cmdpos_raw += 500;					  
					}
					
					else if(csp_pos_delay <= 360)
					 {
						if(i>= 500-2)
							{
							;
					...
					else if(csp_pos_delay <= 550)
					{
						  cmdpos_raw -= 500;					  
					 }
					else if(csp_pos_delay <= 560)
					{
						csp_pos_delay = 25;
					} 
				break;
...
//      {
//        outputs1->ControlWord = 0x0080;
//      }
		}
    
	 outputs1->target_pos = cmdpos_raw;
