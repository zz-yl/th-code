...
static uint16_t comm_msg_MSG_MOTOR_POS(uint8_t *data)
{
    ...
    comm_float_to_u8(motor_data[MOTOR_1].pos, &data[len]);
    len += 4;
    comm_float_to_u8(motor_data[MOTOR_2].pos, &data[len]);
    len += 4;
    comm_float_to_u8(motor_data[MOTOR_3].pos, &data[len]);
    len += 4;
    comm_float_to_u8(motor_data[MOTOR_4].pos, &data[len]);
    len += 4;
    comm_float_to_u8(motor_data[MOTOR_5].pos, &data[len]);
    len += 4;
...
static uint16_t comm_msg_MSG_DEVICE_STATE(uint8_t *data)
{
    ...
    data[len++] = (uint8_t)((motor_data[MOTOR_1].state_r == MOTOR_RUN) | ((motor_data[MOTOR_2].state_r == MOTOR_RUN) << 1) | ((motor_data[MOTOR_3].state_r == MOTOR_RUN) << 2)
                   | ((motor_data[MOTOR_4].state_r == MOTOR_RUN) << 3) | ((motor_data[MOTOR_5].state_r == MOTOR_RUN) << 4));
    data[len++] = 0;
    data[len++] = 0;
    data[len++] = 0;
...
static uint16_t comm_msg_MSG_ALL_POS(uint8_t *data)
{
    ...
    comm_u32_to_u8(motor_data[MOTOR_1].pos_all, &data[len]);
    len += 4;                
    comm_u32_to_u8(motor_data[MOTOR_2].pos_all, &data[len]);
    len += 4;                
    comm_u32_to_u8(motor_data[MOTOR_3].pos_all, &data[len]);
    len += 4;                
    comm_u32_to_u8(motor_data[MOTOR_4].pos_all, &data[len]);
    len += 4;                
    comm_u32_to_u8(motor_data[MOTOR_5].pos_all, &data[len]);
    len += 4;
...
static uint16_t comm_msg_MSG_ALL_TIME(uint8_t *data)
{
    ...
    comm_u32_to_u8(motor_data[MOTOR_1].tim_run, &data[len]);
    len += 4;
